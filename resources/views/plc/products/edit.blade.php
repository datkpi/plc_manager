{{-- views/plc/products/edit.blade.php --}}
...
<div class="card">
   ...
   <div class="card-body">
       ...
       <form action="{{ route('plc.products.update', $product->id) }}" method="POST">
           @csrf
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="number" step="0.01" class="form-control" name="gm_spec"
                              value="{{ old('gm_spec', $product->gm_spec) }}" required>
                   </div>
               </div>
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="number" step="0.01" class="form-control" name="min_productivity"
                              value="{{ old('min_productivity', $product->min_productivity) }}" required>
                   </div>
               </div>
           </div>
