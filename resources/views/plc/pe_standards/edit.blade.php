{{-- views/plc/pe_standards/edit.blade.php --}}
@extends('plc.layouts.master')
@section('content')
<div class="card">
   <div class="card-header">
       <h3 class="card-title">Cập nhật tiêu chuẩn cuộn PE</h3>
   </div>
   ...
   <div class="card-body">
       ...
       <form action="{{ route('plc.pe_standards.update', $standard->id) }}" method="POST">
           @csrf
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="number" class="form-control" name="diameter"
                              value="{{ old('diameter', $standard->diameter) }}"
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="number" class="form-control" name="length"
                              value="{{ old('length', $standard->length) }}"
                              required min="1" step="1"
