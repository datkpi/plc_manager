...
@section('content')
    ...
    <form action="{{ route('recruitment.source.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="link" type="text" class="form-control" value="{{ $data->link }}"
                                placeholder="Nhập ...">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="phone_contact" type="text" class="form-control"
                                value="{{ $data->phone_contact }}" placeholder="Nhập ...">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email_register" type="email" class="form-control"
                                value="{{ $data->email_register }}" placeholder="Nhập ...">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="contact" class="form-control" id="ckeditor" rows="3" placeholder="Nhập mô tả ...">{{ $data->contact }}</textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <!-- textarea -->
