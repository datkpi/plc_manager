...
<form action="{{ route('recruitment.mail_template.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-3">
            <div class="card">
        ...
        <div class="col-sm-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <input class="form-control" id="thumbnail" name="file" type="text" value="">
                        </div>
                        <div class="col-sm-3">
                            <button class="form-control" id="lfm" data-input="thumbnail" multiple
                                data-preview="holder">Chọn
...
<script>
    var options = {
        ...
        var editor = CKEDITOR.instances['ckeditor_body'];
        ...
        $(document).ready(function() {
            $('.placeholder').on('click', function(e) {
                ...
                var cursorPosition = editor.getSelection().getRanges()[0];

                // Chèn giá trị placeholder vào vị trí con trỏ chuột
               editor.insertText('\{\{' + field + '\}\}', cursorPosition);
            });
        });
</script>
