    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="col-12 col-sm-12">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="{{ $stage == 0 ? 'nav-link active' :  'nav-link'}}"
                            ...
                            role="tab" aria-controls="custom-tabs-four-interview0" aria-selected="true">Phỏng vấn sơ bộ
                            ({{
                            $candidate->interview_result0_value }})</a>
                    </li>
                    <li class="nav-item">
                        <a class="{{ $stage == 1 ? 'nav-link active' :  'nav-link'}}"
                            ...
                            role="tab" aria-controls="custom-tabs-four-interview1" aria-selected="true">Phỏng vấn vòng
                            1 ({{
                    ...
                    <li class="nav-item">
                        <a class="{{ $stage == 2 ? 'nav-link active' :  'nav-link'}}"
                            ...
                            role="tab" aria-controls="custom-tabs-four-interview2" aria-selected="false">Phỏng vấn vòng
                            2
                    ...
                    <li class="nav-item">
                        <a class="{{ $stage == 3 ? 'nav-link active' :  'nav-link'}}"
                            ...
                            role="tab" aria-controls="custom-tabs-four-interview3" aria-selected="false">Phỏng vấn vòng
                            3
                            ({{ ($candidate->interview_result3_value) }})</a>
                    </li>
                    <li class="nav-item">
                        <a class="{{ $stage == 4 || $stage == 5 ? 'nav-link active' :  'nav-link'}}"
                            id="custom-tabs-four-interview4-tab" data-toggle="pill" href="#custom-tabs-four-interview4"
                            role="tab" aria-controls="custom-tabs-four-interview4" aria-selected="false">Nhận việc </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content" id="custom-tabs-four-tabContent">
                ...
                @endif
                @endforeach
                <div class="tab-pane fade show {{$candidate->stage == 4 || $candidate->stage == 5 ? 'active' : ''}}" id="custom-tabs-four-interview3" role="tabpanel"
