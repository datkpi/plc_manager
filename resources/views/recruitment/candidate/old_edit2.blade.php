                        ...
                        @if($i == 0)
                            <li class="nav-item">
                                <a class="{{ $stage == 0 ? 'nav-link active' :  'nav-link'}}"
                                    ...
                                    role="tab" aria-controls="custom-tabs-four-interview{{$i}}" aria-selected="true">{{$candidate->{"interview_result" . $i . "_value"} }} Phỏng vấn sơ bộ
                                </a>
                            </li>
                        @else
                            <li class="nav-item">
                                <a class="{{ $stage == $i ? 'nav-link active' :  'nav-link'}}"
                                    id="custom-tabs-four-interview{{$i}}-tab" data-toggle="pill" href="#custom-tabs-four-interview{{$i}}"
                                    role="tab" aria-controls="custom-tabs-four-interview{{$i}}" aria-selected="true">{{$candidate->{"interview_result" . $i . "_value"} }} Phỏng vấn vòng {{$i}}
                                </a>
                            </li>
                        @endif
                    @endfor
