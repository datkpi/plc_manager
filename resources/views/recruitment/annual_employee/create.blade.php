...
@section('content')
    ...
    <form action="{{ route('recruitment.annual_employee.store') }}" method="POST" enctype="multipart/form-data" lang="vi">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select name="month" class="form-control" data-placeholder="Select">
                                {!! \App\Common\StringHelpers::getSelectMonth() !!}
                            </select>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select name="year" class="form-control select2" data-placeholder="Select">
                                {!! \App\Common\StringHelpers::getSelectYear() !!}
                            </select>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="employee_number" type="text" value="" class="form-control"
                                placeholder="Nhập ...">
