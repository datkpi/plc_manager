...
@section('content')
    <form action="{{ route('recruitment.role.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="checkbox" name="selected_routes[]"
                                                                value="{{ $routeName }}" {{ in_array($routeName, $permisions) ? 'checked' : '' }}>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.module-dropdown').on('show.bs.dropdown', function () {
                ...
                $(this).next('.module-table').show();
            });

            $('.module-dropdown').on('hide.bs.dropdown', function () {
                // Ẩn tất cả các module khi dropdown bị đóng
                $('.module-table').hide();
            });
