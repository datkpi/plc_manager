...
@section('content')
    ...
    <form action="{{ route('recruitment.request_form_config.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="deadline_after" value="{{ $data->deadline_after }}" type="text"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input name="pass_approve" type="checkbox" class="custom-control-input" id="customSwitch3"
                                    {{ $data->pass_approve ? 'checked' : '' }}>
