...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <input lang="vi-VN" class="form-control" type="month" name="date_from" value="{{ old('date_from', now()->startOfYear()->format('Y-m')) }}">
            </div>
        </div>
        <div class="col-sm-2">
            <div class="form-group">
                <label>Tới tháng</label>
                <input class="form-control" type="month" name="date_to" value="{{ old('date_to', now()->format('Y-m')) }}" lang="vi-VN">
            </div>
        </div>
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <select name="display_type" class="form-control">
                    <option selected value="group">Tổng gộp dữ liệu</option>
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="demo-container">
                <div id="pivotgrid-demo">
                    ...
                    <div class="mt-1" id="pivotgrid"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('js/devxtreme/report/index.js') }}"></script>
