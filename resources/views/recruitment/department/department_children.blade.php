@foreach($datas as $data)
    ...
    <td class="project-actions">
        ...
        <form action="{!! route('recruitment.department.destroy', $data->id) !!}" method="POST" style="display: inline-block">
            {!! method_field('DELETE') !!}
            {!! csrf_field() !!}
    ...
    @if ($data->children->isNotEmpty())
        @include('recruitment.department.department_children', ['datas' => $data->children, 'depth' => $depth+1])
    @endif
@endforeach
