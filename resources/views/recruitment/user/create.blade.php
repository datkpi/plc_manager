...
<form action="{{ route('recruitment.user.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <img id="preview_image" src="{{ asset('storage/photos/shares/thumbs/default-thumbnail.jpg') }}" style=""
