        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ route('personnel.department.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('personnel.position.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('personnel.user.index') }}" class="nav-link">
