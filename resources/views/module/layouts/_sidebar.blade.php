...
<aside class="main-sidebar main-sidebar-custom sidebar-dark-success elevation-4">
    ...
    <a href="{{route('module.index')}}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Tiền Phong HRM</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-header">Cơ cấu tổ chức</li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.department.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('recruitment.position.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('recruitment.user.index') }}" class="nav-link">
                        <i class="fa fa-users nav-icon"></i>
                        <p>Danh sách nhân sự</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.role.index') }}" class="nav-link">
                        <i class="fa fa-lock nav-icon" aria-hidden="true"></i>
                        <p>Vai trò/ quyền hạn</p>
                    </a>
                </li>
                </li>
                <li class="nav-header">Quản lý tuyển dụng</li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.candidate.index') }}" class="nav-link">
                        <i class="fa fa-user nav-icon" aria-hidden="true"></i>
                        <p>Ứng viên</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.interview_schedule.index') }}" class="nav-link">
                        <i class="fa fa-calendar nav-icon" aria-hidden="true"></i>
                        <p>Lịch phỏng vấn</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.request_form.index') }}" class="nav-link">
                        <i class="fas fa-file-invoice nav-icon"></i>
                        <p>Phiếu đề xuất tuyển dụng</p>
                    </a>
                </li>
                {{-- <li class="nav-item">
                    <a href="{{ route('recruitment.recruitment_plan.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('recruitment.mail_template.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cấu hình mẫu email</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('recruitment.approve.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cấu hình người duyệt phiếu đề xuất</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('recruitment.request_form_config.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cấu hình phiếu đề xuất</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ route('recruitment.report.recruitment.interviewRate') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Tỷ lệ chuyển đổi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('recruitment.report.recruitment.candidate') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Hồ sơ trúng tuyển</p>
                            </a>
                        </li> --}}
                        {{-- <li class="nav-item">
                            <a href="{{ route('recruitment.report.recruitment.expense') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Chi phí tuyển dụng</p>
                            </a>
                        </li> --}}
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('recruitment.activity.index') }}" class="nav-link">
                ...
                {{-- <li class="nav-header">Quản lý gửi mail</li>
                <li class="nav-item">
                    <a href="{{ route('recruitment.mail.index') }}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Gửi mail</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('recruitment.mail_group.index') }}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Nhóm mail</p>
                    </a>
                </li> --}}
