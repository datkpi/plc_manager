...
var gridData = $('#gridData').dxDataGrid({
    ...
    columns: [{
            dataField: "name",
            caption: "Tên kế hoạch tuyển dụng",
        ...
        },
        {
            ...
            cellTemplate: function (container, options) {
                ...
                if (statusName == 'process') {
                    ...
                    statusValue = 'Kết thúc'
                }
                $('<div/>')
                    .addClass('badge')
                    .addClass('badge-pill')
                    .addClass(getBootstrapBadgeClass(statusName))
                    .text(statusValue)
                    .appendTo(container);
            },
        },
        {
            ...
            cellTemplate: function (container, options) {
                $('<a/>').addClass('dx-link')
                    .text('Xem')
                    .attr("href", "/recruitment/recruitment-plan/edit/" + options.data.id)
                    .appendTo(container);
            }
        },
        // {
...
function deleteData(id) {
    $.ajax({
        ...
        dataType: "JSON",
        type: 'delete',
        url: '/recruitment/recruitment-plan/destroy/' + id,
        //data: { data: e.data },
        success: function (data) {
...
function GetData() {
    $.ajax({
        ...
        url: '/api/recruitment/recruitment-plan/get-data',
        dataType: 'json',
        async: false,
