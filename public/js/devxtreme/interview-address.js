    ...
    toolbarItems: [
        {
            ...
            options: {
                text: "Lưu",
                onClick: function () {
                    var formInstance = $("#addRecruitmentPlanPopup")
                        .dxPopup("instance")
                        .content()
                        .dxForm("instance");
                    var form = $("#addRecruitmentPlanPopup")
                        .dxPopup("instance")
                        .content()
                        .dxForm("instance");
    ...
    .dxDataGrid({
            ...
            },
            {
                ...
                cellTemplate: function (container, options) {
                    $("<a/>")
                        ...
                        .attr(
                            "href",
                            "/recruitment/interview-address/edit/" + options.data.id
                        )
                        .appendTo(container);
                },
            },
        ...
        onRowRemoved: function (e) {
            $.ajax({
                dataType: "JSON",
                type: "POST",
                url: "/recruitment/interview-address/Delete",
                data: {
                    data: e.data,
                },
                success: function (data) {
        ...
        onToolbarPreparing: function (e) {
            ...
            var exportButtonIndex = e.toolbarOptions.items.findIndex(function (
                item
            ) {
...
function GetData() {
    $.ajax({
        ...
        url: "/api/recruitment/interview-address/get-data",
        dataType: "json",
        async: false,
