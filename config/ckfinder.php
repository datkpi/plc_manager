...
// Chủ động đường dẫn đến ckeditor (true -> false)
$config['loadRoutes'] = false;

// Thêm middleware bảo vệ cho ckfinder
$config['authentication'] = '\App\Http\Middleware\UnisharpAuthentication';

/*============================ License Key ============================================*/
// http://docs.cksource.com/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'localhost';
$config['licenseKey']  = 'HPDPMCVNJ3EJSKBMQ44Q4E2KW7SHN';
